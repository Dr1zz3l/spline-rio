...
"intensity"       (FLOAT32)  - SNR in dB (driver: sideInfo.snr / 10)
                              ^ SDK 3.x. This was "reflected power" on
                                pre-3.x firmware; the field is now the
                                on-chip SNR with a 0.1 dB quantum, so any
                                law of the form var ~ 1/SNR must be applied
                                to 10^(I/10), not to I.
