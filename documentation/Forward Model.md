...
A systematic z-velocity underestimate of −0.5 to −0.65 m/s is measured
(mechanism open; the earlier “limited elevation diversity, 2 TX” attribution
was wrong for the AOP package — 3TX×4RX, ~symmetric az/el resolution;
correction 2026-08-12, floor multipath the leading candidate).  Huber loss threshold `δ = 1.0 m/s` is
