...
\multirow{2}{*}{Backflips\textsuperscript{$\ddagger$}}
  & Settled & 3.47\textsuperscript{$\ast$} & 5.01 & 1.674 & 3.09 & \multirow{2}{*}{0.6} \\
...
($>$90\% of distance), with velocity \ac{rmse} rising to 2.4 and
...
Window duration has little effect on slow racing (live 0.30--0.34\,m
across 1.5--5\,s); on fast racing a 3\,s window modestly beats a 2\,s
one (a confirmed observability limit, \autoref{sec:backflips}), so 3\,s
is the default --- balancing latency against accuracy.
