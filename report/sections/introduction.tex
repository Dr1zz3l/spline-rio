...
\begin{itemize}
  ...
  \item A \emph{consistency-analyzed} fixed-lag smoother: a factor-set
        ...
        real-time operating point per regime at near-identical accuracy
...
\url{https://github.com/Dr1zz3l/radar-iwr6843-driver}, which despite its
driver-style name hosts the complete estimator, solver, and datasets.
