...
the heading-aided orientation numbers are correspondingly optimistic;
the heading-\emph{independent} roll/pitch decomposition
(\autoref{tab:baselines}(b)) and the unaided-yaw check
(\autoref{sec:baselines}) isolate attitude accuracy from this
idealization.  Without it, yaw drifts freely and position direction
error accumulates.  This is therefore a sensor-architecture note rather
