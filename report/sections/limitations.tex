...
bound this by re-running with a magnetometer surrogate on the heading prior
(a slowly-varying $2\degree$ heading drift, a half-period sine that the
start-anchored alignment cannot cancel, plus $1.5\degree$ white noise,
seeded): live orientation degrades by at most $0.3\degree$ (fast racing
$2.88\to3.17\degree$; slow $1.97\to1.88\degree$, backflips
$6.35\to6.34\degree$ unchanged).  The \SI{1}{\kilo\hertz} gyroscope
constrains yaw \emph{rate} so the slow drift is resisted, the white noise
averages out, and backflip orientation error is roll/pitch- not
yaw-dominated, so the headline is robust to heading-sensor imperfection;
