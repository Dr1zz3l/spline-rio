...
over-trust ($\lambda_\psi{=}10$ near-optimal).  Under large attitude
excursions this fails: as the body inverts the body-frame offset swings
through the horizontal plane, making the heading error attitude-correlated
rather than a gauge; our heading-frame perturbation misses this, so the
${\sim}0.6\degree$ backflip figure is a lower bound.  Modeling an attitude-
and throttle-correlated real magnetometer against ground truth is future
work.  The
