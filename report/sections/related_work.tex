...
for stereo-inertial odometry, as does the continuous-time stereo-inertial
odometry of Hug et al.~\cite{hug2022continuous}. We adapt the basalt-style
...
the window.  These select the factors to
