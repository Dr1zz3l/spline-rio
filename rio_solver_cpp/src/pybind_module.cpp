...
PYBIND11_MODULE(rio_solver, m) {
    ...
    py::class_<SolverConfig>(m, "SolverConfig")
        ...
        .def_readwrite("radar_weight", &SolverConfig::radar_weight)
        ...
        .def_readwrite("lambda_gyro_omega_sigma", &SolverConfig::lambda_gyro_omega_sigma)
        .def_readwrite("lambda_gyro_omega_pow",   &SolverConfig::lambda_gyro_omega_pow)
        ...
        .def_readwrite("bias_rw_sigma_accel", &SolverConfig::bias_rw_sigma_accel)
        .def_readwrite("bias_rw_sigma_gyro", &SolverConfig::bias_rw_sigma_gyro)
        .def_readwrite("radar_frame_sigma_c", &SolverConfig::radar_frame_sigma_c)
        .def_readwrite("radar_frame_hetero", &SolverConfig::radar_frame_hetero)
        .def_readwrite("radar_frame_sigma_z", &SolverConfig::radar_frame_sigma_z)
        .def_readwrite("radar_zbias_state", &SolverConfig::radar_zbias_state)
        .def_readwrite("radar_zbias_prior_sigma", &SolverConfig::radar_zbias_prior_sigma)
        .def_readwrite("radar_zbias_rw_sigma", &SolverConfig::radar_zbias_rw_sigma)
        .def_readwrite("huber_omega_sigma", &SolverConfig::huber_omega_sigma)
        .def_readwrite("huber_model_knee", &SolverConfig::huber_model_knee)
        .def_readwrite("marg_stale_phi", &SolverConfig::marg_stale_phi)
        .def_readwrite("marg_stale_pos", &SolverConfig::marg_stale_pos)
        .def_readwrite("boundary_first_window_only", &SolverConfig::boundary_first_window_only)
    ...
    py::class_<SolverResult>(m, "SolverResult")
        ...
        .def_readonly("radar_zbias", &SolverResult::radar_zbias)
        ...
        .def_readonly("marg_theta_swept",           &SolverResult::marg_theta_swept)
        .def_readonly("marg_bound_dphi",            &SolverResult::marg_bound_dphi)
    ...
    m.def("make_radar_frame",
        [](double timestamp,
           py::array_t<double, py::array::c_style | py::array::forcecast> pts) {
            ...
            const bool has_weight = r.shape(1) >= 6;
            ...
            for (int i = 0; i < n; ++i) {
                ...
                frame.points[i].w = has_weight ? r(i, 5) : 1.0;
            }
            return frame;
        },
    ...
    py::class_<SlidingWindowSolver>(m, "SlidingWindowSolver")
        ...
        .def_property_readonly("radar_zbias",
            [](const SlidingWindowSolver& s) { return s.radar_zbias(); });
