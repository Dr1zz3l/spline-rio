...
# 2-panel-per-bag (position + orientation) single-column layout; velocity is
# covered by the RMSE tables. Authored ~6.5in, displayed at \columnwidth (~0.53x).
fig, axes = plt.subplots(len(BAGS), 2, figsize=(6.5, 2.7 * len(BAGS)))
if len(BAGS) == 1:
