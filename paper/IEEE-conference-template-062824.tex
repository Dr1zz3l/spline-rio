...
\centering
\footnotesize
% Box (b) first to learn its width, then stretch the narrower (a) to the
% same span so both subtables centre on one shared axis (no left-shift).
\setlength{\tabcolsep}{5pt}%
\sbox0{\begin{tabular}{lccccccccc}
\toprule
\multicolumn{10}{l}{\textit{(b)~Decomposition}}\\
\midrule
...
\makebox[\wd0][c]{\begin{tabular}{lccc}
\toprule
